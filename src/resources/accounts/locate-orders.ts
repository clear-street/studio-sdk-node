...
export class LocateOrders extends APIResource {
   ...
   */
  create(accountId: string, body: LocateOrderCreateParams, options?: Core.RequestOptions): Core.APIPromise<Shared.LocateOrder> {
   ...
   */
  retrieve(accountId: string, locateOrderId: string, options?: Core.RequestOptions): Core.APIPromise<Shared.LocateOrder> {
   ...
   */
  update(accountId: string, locateOrderId: string, body: LocateOrderUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    return this._client.patch(`/accounts/${accountId}/locate-orders/${locateOrderId}`, { body, ...options, headers: { Accept: '*/*', ...options?.headers } });
  }
