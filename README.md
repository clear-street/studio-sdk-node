# Studio SDK TypeScript API Library

[![NPM version](<https://img.shields.io/npm/v/@clear-street/studio-sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/@clear-street/studio-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@clear-street/studio-sdk)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/studio-sdk-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install @clear-street/studio-sdk`
...
1. Via the `STUDIO_SDK_LOG` environment variable
...
const client = new StudioSDK({
  logger: logger.child({ name: 'StudioSDK' }),
...
const client = new StudioSDK({ fetch });
```
...
```ts
import StudioSDK from 'npm:@clear-street/studio-sdk';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/studio-sdk-typescript/issues) with questions, bugs, or suggestions.
