...
```sh
npm install git+ssh://git@github.com:stainless-sdks/studio-sdk-node.git
```
...
add the following import before your first import `from "StudioSDK"`:
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/stainless-sdks/studio-sdk-node/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/studio-sdk-node/issues) with questions, bugs, or suggestions.
