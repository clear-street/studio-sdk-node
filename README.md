...
```sh
npm install git+ssh://git@github.com:sachnk/studio-sdk-node.git
```
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/sachnk/studio-sdk-node/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/sachnk/studio-sdk-node/issues) with questions, bugs, or suggestions.
