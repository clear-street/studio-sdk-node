import fs from 'fs';
import type { ResponseLike } from '@clear-street/studio-sdk/internal/to-file';
import { toFile } from '@clear-street/studio-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@clear-street/studio-sdk/core/uploads');
    await expect(
