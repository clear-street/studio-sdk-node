...
describe('resource trades', () => {
  test('retrieve: only required params', async () => {
    const responsePromise = client.accounts.trades.retrieve('12390213', { account_id: '100000' });
  ...
  test('retrieve: required and optional params', async () => {
    const response = await client.accounts.trades.retrieve('12390213', { account_id: '100000' });
  });
